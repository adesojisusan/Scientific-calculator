...
root_label.grid(row=0, column=0 , columnspan=4)
...
button_muiltiply = tkinter.Button(root, text ='*', command = lambda: add('*'))
button_muiltiply.grid(row=2, column = 3)
...
button_addition = tkinter.Button(root, text ='+', command = lambda: add('+'))
...
button_substract = tkinter.Button(root, text ='-', command = lambda: add('-'))
